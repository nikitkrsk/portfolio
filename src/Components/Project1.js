...
function Cross() {
  ...
  return (
    <group ref={ref} scale={[2, 2, 2]}>
      <Plane scale={[1, 0.2, 0.2]} color="#fff" />
      <Plane scale={[0.2, 1, 0.2]} color="#fff" />
    </group>
  )
}
    ...
    <>
      ...
      <Block factor={1.5} offset={0}>
        <Content left map={img1}>
          ...
          Pastry Boutique CREME is a company with modern approach to the industry where they operate. <br />
          They aim to bring the best quality of the latest trends to local market. 
          </Dom>
        </Content>
      </Block>
      {/* Second section */}
      <Block factor={2.0} offset={1}>
        <Content map={img2}>
          ...
          Our goal was to create modern and fast website-catalogue 
          that will not only give an opportunity to get familiar with products, but also make an order and watch the latest updates from Instagram.
          </Dom>
        </Content>
      </Block>
      {/* Stripe */}
      ...
      <Block factor={1.5} offset={2}>
        <Content left map={img3}>
          ...
          As the company aims on multicultural audience, there was decided on multiple choice of languages with split-second switch between options.
           <br />
         In case if someone would like to contact the organization, there is an easily accessible contact form to send a request with optional title.
          </Dom>
        </Content>
      </Block>
    </>
...
function App() {
  ...
  const title = 'Pastry Boutique Creme'
  useEffect(() => {
